...
function Tooltip({ ...properties }: ComponentProps<typeof TooltipPrimitive.Root>): ReactElement {
  return (
    <TooltipProvider>
...
function TooltipTrigger({ ...properties }: ComponentProps<typeof TooltipPrimitive.Trigger>): ReactElement {
