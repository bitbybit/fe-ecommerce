...
const NavigationMenu = forwardRef<ElementRef<typeof Root>, ComponentPropsWithoutRef<typeof Root>>(
  function NavigationMenu({ className, children, ...properties }, reference) {
    return (
      <Root
        ref={reference}
...
const NavigationMenuList = forwardRef<ElementRef<typeof List>, ComponentPropsWithoutRef<typeof List>>(
  function NavigationMenuList({ className, ...properties }, reference) {
    return (
      <List
        ref={reference}
...
const NavigationMenuTrigger = forwardRef<ElementRef<typeof Trigger>, ComponentPropsWithoutRef<typeof Trigger>>(
  function NavigationMenuTrigger({ className, children, ...properties }, reference) {
    return (
...
const NavigationMenuContent = forwardRef<ElementRef<typeof Content>, ComponentPropsWithoutRef<typeof Content>>(
  function NavigationMenuContent({ className, ...properties }, reference) {
    return (
      <Content
        ref={reference}
        className={cn(
...
const NavigationMenuViewport = forwardRef<ElementRef<typeof Viewport>, ComponentPropsWithoutRef<typeof Viewport>>(
  function NavigationMenuViewport({ className, ...properties }, reference) {
    return (
...
const NavigationMenuIndicator = forwardRef<ElementRef<typeof Indicator>, ComponentPropsWithoutRef<typeof Indicator>>(
  function NavigationMenuIndicator({ className, ...properties }, reference) {
    return (
      <Indicator
        ref={reference}
        className={cn(
